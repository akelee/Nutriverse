    ...
    <div className="nutriverse__whatNutriverse section__margin" id="what-nutri">
      ...
      <div className="nutriverse__whatNutriverse-container">
        <div id="quality-recipes">
          <Link to="/recipe">
            <img src={recipe} alt="recipe" width="280px" />
            <Feature text="Quality Recipes" />
          </Link>
        </div>
        <div id="personalised-plans">
          <Link to="/plan">
            <img src={plan} alt="recipe" width="280px" />
            <Feature text="Personalised Plans" />
          </Link>
        </div>
        <div id="meal-planning">
          <Link to="/meal">
            <img src={meal} alt="meal" width="280px" />
            <Feature text="Meal Planning" />
          </Link>
        </div>
      </div>
    </div>
